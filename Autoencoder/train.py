...
from preprocess import SingleAudioDataset
...
config = {
    ...
    "num_epochs": 500,
    "eval_interval": 100,
    "save_dir": "runs/karplus_strong",
    "audio_path": "../audio/guitar.wav"
}

n_samples = config["audio_length_s"] * config["sample_rate"]
...
dataset = SingleAudioDataset(config["audio_path"], segment_length=n_samples)
...
print(f"Loudness stats: mean={mean_loudness}, std={std_loudness}")
